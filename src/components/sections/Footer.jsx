          ...
          <div className="footer-nav__mobile-info">
            <div className="footer-nav__mobile">
              ...
              <div className="footer-nav__mobile-image-container">
                <Link to="/" className="footer-nav__mobile-image-link"><img src="https://es.logodownload.org/wp-content/uploads/2019/06/disponible-en-google-play-badge-1.png" alt="Disponible en Google Play" className="footer-nav__mobile-image" width="162" height="48" loading="lazy" /></Link>
                <Link to="/" className="footer-nav__mobile-image-link"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/Download_on_the_App_Store_Badge_ESMX_RGB_blk.svg/1280px-Download_on_the_App_Store_Badge_ESMX_RGB_blk.svg.png" alt="Descárgalo en el App Store" className="footer-nav__mobile-image" width="144" height="48" loading="lazy" /></Link>
              </div>
            </div>
