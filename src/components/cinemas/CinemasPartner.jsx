    ...
    <section className="home-partner">
      <div className="home-partner__container">
        <div className="home-partner__card-container">
          ...
          <img src="https://cdn.pixabay.com/photo/2018/08/31/02/28/credit-3643710_960_720.png" alt="membership card" className="home-partner__card-image" width="204" height="128" loading="lazy" />
