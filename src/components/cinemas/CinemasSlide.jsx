    ...
    <div className="slick-slider__slide-container">
      ...
      <div className="slick-slider__content">
        ...
        <div className="slick-slider__content-details">
          Cuando sientas que no puedes continuar, cuando sientas que los sueños se te van, cuando creas que ya no hay más razón para avanzar, mantener la fe y piensa en la razón por la cual te esforzaste hasta hoy y vuelve a intentar.
        </div>
        <Link to="/autenticacion/login" className="slick-slider__content-buy">Comprar</Link>
      </div>
    </div>
  );
};
